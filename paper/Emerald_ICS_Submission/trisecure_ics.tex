...
%% -- Float spacing (reduce gaps around tables/figures) -------
\setlength{\floatsep}{8pt plus 2pt minus 2pt}
\setlength{\textfloatsep}{12pt plus 2pt minus 4pt}
\setlength{\intextsep}{8pt plus 2pt minus 2pt}
%% Allow more floats per page and relax placement constraints
...
%%   E-mail: \texttt{g\_saranya@ch.amrita.edu}\\
%%   Contributing authors:
%%   \texttt{ch.sc.u4cys23034@ch.students.amrita.edu};
...
\begin{figure}[htbp]
  ...
  \caption{TRIsecure V2 authentication DFA. The single accepting state
    ...
    \textsc{Rejected} (trap state). Source: Authors.}
  \label{fig:dfa}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Threat model coverage matrix. Green cells (score~2) indicate
    ...
    contribution per layer. Source: Authors.}
...
validated simulation following ISO/IEC~19795-6 \parencite{iso19795_6}.
...
\begin{figure}[htbp]
  ...
  \caption{Numerical comparison: EER (left) and authentication latency
    (right) for systems with reported values. Source: Authors.}
...
simulation evaluation track \parencite{iso19795_6} and standard practice for
...
[BLINDED FOR PEER REVIEW --- full CRediT author contribution statement

...
\title[TRIsecure: A Post-Quantum Biometric E-Voting Framework on Edge Hardware]{%
  TRIsecure: Design and Evaluation of a Post-Quantum Biometric E-Voting
  Framework on Commodity Edge Hardware}
...
\begin{enumerate}
  ...
  \item \textit{Coercion and deniable voting.}
    ...
    schemes~\cite{juels2010coercion,clarkson2008civitas} integrated at the ballot-level, which

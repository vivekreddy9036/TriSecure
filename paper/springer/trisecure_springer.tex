...
\author*[1]{\fnm{Saranya} \sur{G}}\email{g\_saranya@ch.amrita.edu}\equalcont{These authors contributed equally to this work.}

\author[1]{\fnm{S. Udhaya} \sur{Kumar}}\email{u\_udhayakumar@ch.amrita.edu}\equalcont{These authors contributed equally to this work.}
...
systems~\cite{bello2021biometric,komatineni2020biometric,nagaraj2022voting}
...
The Logitech BRIO webcam is connected via USB~3.0 and accessed through
...
available capture resolution tier (640$\times$480), ONNX inference increases to approximately
...
@ 1.8~GHz (quad-core, 64-bit). Logitech BRIO USB webcam (operated at
1080p/30~fps). PN532 NFC module (SPI).
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/comparison_combined_panel.png}
...
developed and verified by the authors. The full codebase and all experiment
...
\item \textbf{Availability of data and materials.} The dataset(s) supporting
  ...
  \begin{itemize}
    \item[] \textbf{Project name:} TRIsecure V2
    \item[] \textbf{Project home page:}
      \url{https://github.com/vivekreddy9036/TriSecure}
    \item[] \textbf{Archived version:} Tagged release corresponding to this
      manuscript's submitted results (repository release tags)
    \item[] \textbf{Operating system(s):} Linux (target deployment:
      Raspberry Pi OS / Ubuntu~22.04 ARM64); evaluation and simulation
      scripts are platform-independent
    \item[] \textbf{Programming language:} Python~3.11
    \item[] \textbf{Other requirements:} ONNX Runtime~1.17, NumPy~1.26,
      SciPy, pandas, scikit-learn; see \texttt{requirements.txt} in the
      repository for the full dependency list

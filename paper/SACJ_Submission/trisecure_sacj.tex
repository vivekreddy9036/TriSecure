...
%%   3. Copy all PNG/JPG files from springer/figures/ into the
%%      figures/ subfolder here (JPG preferred for Overleaf compile speed)
...
%% -- Packages not already loaded by sacjsub.cls --------------
%% (sacjsub loads: graphicx, multirow, microtype, natbib, hyperref,
%%  url, geometry, fancyhdr, lastpage, sectsty, titlesec, csquotes, caption)
...
%% For camera-ready, replace with: Surname, I., Surname, I., and Surname, I.
%% \SACJcitationauthors{Pinnemcharla Sai Vivek Reddy, Saranya G and S.\ Udhaya Kumar}
...
et al.~\cite{paquin2020oqs} benchmark liboqs across x86 and ARM.
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/gap_matrix.jpg}
...
(\(t{=}3\), \(m{=}64\)~MB)~\cite{biryukov2016argon2}.
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/threat_model_heatmap.jpg}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/biometric_eval_panel.jpg}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/ablation_panel.jpg}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/adversarial_panel.jpg}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.48\linewidth]{figures/comparison_table.jpg}
  \includegraphics[width=0.48\linewidth]{figures/comparison_bar.jpg}
...
\begin{enumerate}
  ...
  \item \textit{Coercion and deniable voting.}
    ...
    schemes~\cite{juels2005coercion,clarkson2008civitas}.

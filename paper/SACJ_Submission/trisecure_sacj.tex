...
%% --- Authors ------------------------------------------------
%% DOUBLE-BLIND REVIEW: all author lines are commented out.
%% YOU MUST list all authors correctly on the journal web form.
%% Uncomment below ONLY after acceptance for the camera-ready version.
%
% \SACJauthor[a]{Pinnemcharla Sai Vivek Reddy}{vivekreddy9036@gmail.com}{corresponding}
% \SACJauthor[a]{Saranya G}{g\_saranya@ch.amrita.edu}{}
...
%% --- Running header ------------------------------------------
\SACJrunningheader{[Authors omitted for blind review]}{TRIsecure: Post-Quantum Biometric E-Voting on Edge Hardware}

...
Simulation-based evaluation achieves EER~\(=1.55\%\),
...
and CelebA-Spoof~\cite{zhang2020minifasnet}. Current APCER
figures (5.0\%~print, 10.0\%~replay) are derived from published
MiniFASNetV2 benchmark rates and are labelled accordingly.
...
Future work includes: (i)~live field trial with demographic analysis per
ISO/IEC~19795-1 Clause~8 (minimum 400 subjects/group); (ii)~native

...
post-quantum cryptography, liveness detection, and end-to-end verifiability
on sub-\$100 edge hardware.
\end{abstract}
...
The \textbf{novel contribution} is their \emph{principled co-design}:
...
quantum-resistant cryptography, liveness detection, and edge deployability
on sub-\$100 hardware.
